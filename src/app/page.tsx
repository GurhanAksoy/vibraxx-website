  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'linear-gradient(to bottom right, #020817, #0a0a1a, #020817)', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="animate-float" style={{ position: 'fixed', top: '5%', left: '-5%', width: '400px', height: '400px', borderRadius: '50%', background: 'radial-gradient(circle, #7c3aed 0%, transparent 70%)', opacity: 0.2, filter: 'blur(80px)', zIndex: 0 }} />
        <div className="animate-float" style={{ position: 'fixed', bottom: '10%', right: '-5%', width: '500px', height: '500px', borderRadius: '50%', background: 'radial-gradient(circle, #d946ef 0%, transparent 70%)', opacity: 0.15, filter: 'blur(80px)', zIndex: 0, animationDelay: '2s' }} />
        <div className="animate-float" style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '300px', height: '300px', borderRadius: '50%', background: 'radial-gradient(circle, #eab308 0%, transparent 70%)', opacity: 0.1, filter: 'blur(80px)', zIndex: 0, animationDelay: '1s' }} />
        ...
        <header style={{ position: 'sticky', top: 0, zIndex: 50, borderBottom: '1px solid rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(20px)', background: 'rgba(2, 8, 23, 0.95)' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', minHeight: '70px', gap: '12px', flexWrap: 'wrap', padding: '8px 0' }}>
              
              {/* Logo */}
              <div onClick={() => navigate('/')} style={{ display: 'flex', alignItems: 'center', gap: '16px', cursor: 'pointer' }}>
                <div className="animate-neon-pulse" style={{ width: isMobile ? '80px' : '100px', height: isMobile ? '80px' : '100px', borderRadius: '50%', background: '#0f0f1a', border: '3px solid #7c3aed', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '10px' }}>
                  <img src="/images/logo.png" alt="VibraXX Logo" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                </div>
                <div style={{ fontSize: isMobile ? '11px' : '14px', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 700 }}>
                  LIVE QUIZ ARENA
                </div>
              </div>
          ...
          {/* Live status bar */}
          <div style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)', background: 'linear-gradient(90deg, rgba(139, 92, 246, 0.1), rgba(236, 72, 153, 0.08))', backdropFilter: 'blur(16px)', padding: isMobile ? '10px 0' : '12px 0' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: isMobile ? '12px' : '32px', flexWrap: 'wrap', fontSize: isMobile ? '11px' : '14px' }}>
        ...
        {/* Main Content */}
        <main style={{ position: 'relative', zIndex: 10, padding: isMobile ? '30px 16px' : '60px 24px' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            
            {/* Hero Section */}
            <div style={{ textAlign: 'center', marginBottom: isMobile ? '40px' : '80px' }}>
              <div className="animate-glow-pulse" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: isMobile ? '8px 16px' : '10px 24px', borderRadius: '9999px', border: '2px solid rgba(234, 179, 8, 0.4)', background: 'linear-gradient(135deg, rgba(234, 179, 8, 0.15), rgba(202, 138, 4, 0.1))', backdropFilter: 'blur(10px)', marginBottom: isMobile ? '20px' : '24px', boxShadow: '0 0 40px rgba(234, 179, 8, 0.4), 0 8px 24px rgba(0, 0, 0, 0.3)', transition: 'all 0.3s ease' }}>
                <Trophy style={{ width: isMobile ? '18px' : '20px', height: isMobile ? '18px' : '20px', color: '#facc15' }} />
                <span style={{ fontSize: isMobile ? '12px' : '16px', fontWeight: 700, background: 'linear-gradient(135deg, #fef08a, #facc15)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                  £{prizePool?.amount || 1000} MONTHLY GRAND PRIZE
                </span>
              </div>

              {prizePool && prizePool.current_participants < prizePool.required_participants && (
                <div className="animate-scale-in" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: isMobile ? '8px 16px' : '10px 20px', borderRadius: '12px', background: 'linear-gradient(135deg, rgba(34, 197, 94, 0.15), rgba(16, 185, 129, 0.1))', backdropFilter: 'blur(10px)', border: '1px solid rgba(34, 197, 94, 0.3)', marginBottom: isMobile ? '16px' : '20px', fontSize: isMobile ? '11px' : '13px', fontWeight: 600, color: '#22c55e', boxShadow: '0 4px 16px rgba(34, 197, 94, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)', transition: 'all 0.3s ease' }}>
                  <Sparkles style={{ width: '14px', height: '14px' }} />
                  <span>Cash prize unlocks at 2,000 active players • Currently {prizePool.current_participants} joined!</span>
                </div>
              )}

              <h1 style={{ fontSize: isMobile ? '28px' : '64px', fontWeight: 900, lineHeight: 1.1, marginBottom: isMobile ? '16px' : '24px', letterSpacing: '-0.02em', padding: '0 16px' }}>
              ...
              <p style={{ fontSize: isMobile ? '14px' : '20px', color: '#94a3b8', maxWidth: '700px', margin: isMobile ? '0 auto 30px' : '0 auto 40px', lineHeight: 1.6, padding: '0 16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center', marginBottom: '32px' }}>
                <button onClick={handleJoinQuiz} style={{ position: 'relative', padding: isMobile ? '14px 28px' : '20px 48px', borderRadius: '16px', border: 'none', cursor: 'pointer', fontSize: isMobile ? '15px' : '18px', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '12px', overflow: 'hidden', boxShadow: '0 20px 60px -10px rgba(139, 92, 246, 0.6)', transition: 'transform 0.2s', color: 'white', width: isMobile ? '100%' : 'auto', maxWidth: isMobile ? '350px' : 'none', justifyContent: 'center' }} onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
                ...
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center', width: '100%', maxWidth: isMobile ? '350px' : 'none' }}>
                  <button onClick={handleFreeQuiz} style={{ padding: isMobile ? '10px 16px' : '14px 32px', borderRadius: '12px', border: '1px solid rgba(34, 197, 94, 0.3)', background: 'rgba(34, 197, 94, 0.1)', color: '#22c55e', fontSize: isMobile ? '13px' : '16px', fontWeight: 600, cursor: 'pointer', transition: 'all 0.2s', display: 'flex', alignItems: 'center', gap: '8px', flex: isMobile ? '1' : 'none' }} onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(34, 197, 94, 0.2)'} onMouseLeave={(e) => e.currentTarget.style.background = 'rgba(34, 197, 94, 0.1)'}>
                    <Gift style={{ width: '18px', height: '18px' }} />
                    <span>{isMobile ? 'Free' : 'Try Free Quiz'}</span>
                  </button>

                  <button onClick={handleBuyBundle} style={{ position: 'relative', padding: isMobile ? '10px 16px' : '14px 32px', borderRadius: '12px', border: 'none', background: 'transparent', color: 'white', fontSize: isMobile ? '13px' : '16px', fontWeight: 600, cursor: 'pointer', overflow: 'hidden', display: 'flex', alignItems: 'center', gap: '8px', flex: isMobile ? '1' : 'none' }}>
              ...
              {!user && (
                <p style={{ fontSize: isMobile ? '13px' : '15px', color: '#ef4444', fontWeight: 600, marginBottom: '12px' }}>
            ...
            {/* Prize Pool Section */}
            {prizePool && (
              <div className="animate-pulse-glow animate-slide-up" style={{ padding: isMobile ? '24px' : '48px', borderRadius: '24px', border: '2px solid rgba(234, 179, 8, 0.3)', background: 'linear-gradient(135deg, rgba(234, 179, 8, 0.15), rgba(202, 138, 4, 0.05))', backdropFilter: 'blur(20px) saturate(180%)', marginBottom: isMobile ? '40px' : '60px', boxShadow: '0 12px 48px rgba(234, 179, 8, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px', position: 'relative', zIndex: 1 }}>
                  ...
                  {prizePool.current_participants < prizePool.required_participants ? (
                    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: isMobile ? '12px 20px' : '16px 32px', borderRadius: '16px', background: 'linear-gradient(135deg, rgba(239, 68, 68, 0.2), rgba(220, 38, 38, 0.15))', backdropFilter: 'blur(10px)', border: '2px solid rgba(239, 68, 68, 0.4)', fontSize: isMobile ? '13px' : '15px', fontWeight: 700, color: '#fca5a5', boxShadow: '0 8px 32px rgba(239, 68, 68, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)', animation: 'pulse 2s ease-in-out infinite', maxWidth: '100%', textAlign: 'center' }}>
                    ...
                    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: isMobile ? '12px 20px' : '16px 32px', borderRadius: '16px', background: 'linear-gradient(135deg, rgba(34, 197, 94, 0.2), rgba(22, 163, 74, 0.15))', backdropFilter: 'blur(10px)', border: '2px solid rgba(34, 197, 94, 0.4)', fontSize: isMobile ? '13px' : '15px', fontWeight: 700, color: '#86efac', boxShadow: '0 8px 32px rgba(34, 197, 94, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)' }}>
                ...
                <div style={{ marginBottom: '32px', position: 'relative', zIndex: 1 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                    <span style={{ fontSize: isMobile ? '13px' : '16px', fontWeight: 600, color: '#94a3b8' }}>Participants Required</span>
                ...
                {/* Prize Rules Cards */}
                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? '16px' : '20px', position: 'relative', zIndex: 1 }}>
                  {prizeRules.map((item, i) => (
                    <div key={i} style={{ padding: isMobile ? '16px' : '20px', borderRadius: '16px', background: `rgba(${item.bg === 'green' ? '34, 197, 94' : item.bg === 'purple' ? '139, 92, 246' : '234, 179, 8'}, 0.1)`, border: `1px solid rgba(${item.bg === 'green' ? '34, 197, 94' : item.bg === 'purple' ? '139, 92, 246' : '234, 179, 8'}, 0.2)` }}>
                      <item.icon style={{ width: '24px', height: '24px', color: item.bg === 'green' ? '#22c55e' : item.bg === 'purple' ? '#a78bfa' : '#facc15', marginBottom: '12px' }} />
                      <h3 style={{ fontSize: isMobile ? '15px' : '16px', fontWeight: 700, marginBottom: '8px', color: 'white' }}>{item.title}</h3>
                      <p style={{ fontSize: isMobile ? '13px' : '14px', color: '#94a3b8', lineHeight: 1.5 }}>{item.desc}</p>
                    </div>
                  ))}
                </div>

                <button onClick={() => setShowPrizeModal(true)} style={{ marginTop: '24px', padding: '12px 24px', borderRadius: '12px', border: '1px solid rgba(234, 179, 8, 0.3)', background: 'transparent', color: '#facc15', fontSize: '14px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', margin: '24px auto 0', position: 'relative', zIndex: 1 }} onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(234, 179, 8, 0.1)'} onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
            ...
            {stats && statsData.length > 0 && (
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? '16px' : '24px', marginBottom: isMobile ? '40px' : '60px' }}>
                {statsData.map((stat, i) => (
                  <div key={i} className="glass-card premium-card animate-slide-up" style={{ padding: isMobile ? '24px 20px' : '32px', borderRadius: '20px', textAlign: 'center', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', animationDelay: `${i * 0.1}s`, willChange: 'transform' }}>
                    <stat.icon style={{ width: isMobile ? '28px' : '32px', height: isMobile ? '28px' : '32px', color: stat.color, margin: '0 auto 16px', filter: `drop-shadow(0 0 10px ${stat.color}80)` }} />
                    <div style={{ fontSize: isMobile ? '32px' : '36px', fontWeight: 900, color: stat.color, marginBottom: '8px', textShadow: `0 0 20px ${stat.color}60` }}>
                      {stat.value}
                    </div>
            ...
            {champions.length > 0 && (
              <div style={{ textAlign: 'center' }}>
                <h2 style={{ fontSize: isMobile ? '28px' : '36px', fontWeight: 900, marginBottom: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
                  <Crown style={{ width: isMobile ? '28px' : '32px', height: isMobile ? '28px' : '32px', color: '#facc15', filter: 'drop-shadow(0 0 10px #facc15)' }} />
                ...
                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? '16px' : '24px' }}>
                  {champions.map((champ, i) => (
                    <div key={i} className="glass-card premium-card animate-slide-up" style={{ padding: isMobile ? '24px 20px' : '32px', borderRadius: '20px', textAlign: 'center', transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)', animationDelay: `${i * 0.15}s`, willChange: 'transform' }}>
                      <div className="animate-scale-in" style={{ width: isMobile ? '64px' : '72px', height: isMobile ? '64px' : '72px', margin: '0 auto 20px', borderRadius: '20px', background: champ.gradient, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: `0 0 30px ${champ.color}60, 0 8px 24px rgba(0, 0, 0, 0.3)`, transition: 'all 0.3s ease' }}>
                        <Crown style={{ width: isMobile ? '32px' : '36px', height: isMobile ? '32px' : '36px', color: 'white' }} />
                      </div>
                      <div style={{ fontSize: '12px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#64748b', marginBottom: '8px' }}>
                        {champ.period} Champion
                      </div>
                      <div style={{ fontSize: isMobile ? '18px' : '20px', fontWeight: 700, marginBottom: '8px', color: 'white' }}>
                        {champ.name}
                      </div>
                      <div style={{ fontSize: isMobile ? '24px' : '28px', fontWeight: 900, color: champ.color, textShadow: `0 0 20px ${champ.color}60` }}>
        ...
        {/* Footer */}
        <footer style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)', background: 'rgba(2, 8, 23, 0.95)', backdropFilter: 'blur(20px)', padding: isMobile ? '32px 16px' : '48px 24px', textAlign: 'center', marginTop: isMobile ? '40px' : '60px' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
