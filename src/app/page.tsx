...
useEffect(() => {
      ...
      try {
        ...
        if (data) {
          const diff = Math.floor(
            (new Date(data.start_time).getTime() - new Date().getTime()) / 1000
          );
  ...
  // TIMER + ACTIVE PLAYERS
  useEffect(() => {
    const timer = setInterval(() => {
      setNextRound((prev) => (prev && prev > 0 ? prev - 1 : prev));
  ...
  // PRIZE + STATS + CHAMPIONS
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [prizePoolRes, statsRes, dailyRes, weeklyRes, monthlyRes] =
          await Promise.all([
        ...
        const championsData = [
          {
            period: "Daily",
            name: (dailyRes.data as any)?.profiles?.name || "TBA",
          ...
          {
            period: "Weekly",
            name: (weeklyRes.data as any)?.profiles?.name || "TBA",
          ...
          {
            period: "Monthly",
            name: (monthlyRes.data as any)?.profiles?.name || "TBA",
  ...
  const prizeProgress = useMemo(() => {
    ...
    if (!prizePool.required_participants) return 0;
    return (
      (prizePool.current_participants / prizePool.required_participants) * 100
    );
  }, [prizePool]);
    ...
    () =>
      stats
        ? [
            {
              icon: Globe,
              value: `${Math.floor(stats.total_players / 1000)}K+`,
              label: "Active Players",
              color: "#a78bfa",
            },
            {
              icon: Sparkles,
              value: `${(stats.questions_answered / 1_000_000).toFixed(1)}M+`,
              label: "Questions Answered",
              color: "#f0abfc",
            },
            {
              icon: Zap,
              value: `${stats.daily_rounds}/day`,
              label: "Live Rounds",
              color: "#22d3ee",
            },
          ]
  ...
  const prizeRules = useMemo(
    () => [
      {
        icon: Check,
        title: "Minimum 2000 Players",
        desc: "Rewards activate when we reach 2,000 active participants in the monthly competition.",
        bg: "green",
      },
      {
        icon: Award,
        title: "Rollover System",
        desc: "If the participation target isn't met, only the cash prize is disabled; round rewards are still awarded as usual.",
        bg: "purple",
      },
      {
        icon: Crown,
        title: "Top 3 Performers",
        desc: "1st place wins £1000, 2nd wins 30 rounds, 3rd wins 10 rounds!",
        bg: "yellow",
      },
    ],
    []
  ...
  const prizeList = useMemo(
    () => [
      ...
      {
        place: "2nd",
        reward: "30 Free Rounds",
        icon: "🥈",
        color: "#c0c0c0",
      },
      {
        place: "3rd",
        reward: "10 Free Rounds",
        icon: "🥉",
        color: "#cd7f32",
      },
    ],
    ...
    <>
      ...
      <div
        style={{
          minHeight: "100vh",
          background:
            "linear-gradient(to bottom right, #020817, #0a0a1a, #020817)",
          color: "white",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <div
          style={{
            borderBottom: "1px solid rgba(255, 255, 255, 0.1)",
            background:
              "linear-gradient(90deg, rgba(139, 92, 246, 0.1), rgba(236, 72, 153, 0.08))",
        ...
        >
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, rgba(234, 179, 8, 0.15), rgba(202, 138, 4, 0.1))",
                  backdropFilter: "blur(10px)",
                  marginBottom: isMobile ? "20px" : "24px",
                  boxShadow:
                    "0 0 40px rgba(234, 179, 8, 0.4), 0 8px 24px rgba(0, 0, 0, 0.3)",
              ...
              {prizePool &&
                prizePool.current_participants <
                  prizePool.required_participants && (
                  <div
                  ...
                  >
                    ...
                    />
                    <span>
                      Cash prize unlocks at 2,000 active players •
                      Currently {prizePool.current_participants} joined!
                    </span>
                  </div>
                )}
              ...
              >
                <strong style={{ color: "#a78bfa" }}>Best Deal:</strong> 12
                Rounds = £10 Bundle (Save £2!)
              </p>
            </div>
            ...
            {prizePool && (
              <div
                className="animate-pulse-glow animate-slide-up"
                style={{
                  ...
                  boxShadow:
                    "0 12px 48px rgba(234, 179, 8, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
                  position: "relative",
                  overflow: "hidden",
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    bottom: 0,
                    background:
                      "linear-gradient(135deg, rgba(234, 179, 8, 0.1), transparent, rgba(234, 179, 8, 0.05))",
                    opacity: 0.5,
                    pointerEvents: "none",
                  }}
                />
                ...
                >
                  ...
                  >
                    Test your knowledge and earn rewards. Top performers win
                    prizes!
                  </p>
                  ...
                  prizePool.required_participants ? (
                    ...
                    >
                      ...
                      <span style={{ lineHeight: 1.5 }}>
                        💰 <strong>Cash Prize Unlocks</strong> when we reach{" "}
                        <strong>2,000 active players</strong>
                        <br />
                        <span
                          style={{
                            fontSize: isMobile ? "11px" : "13px",
                    ...
                    >
                      ...
                      />
                      <span>
                        🎉 Cash Prize <strong>ACTIVATED!</strong> (
                        {prizePool.current_participants} players joined!)
                      </span>
                    </div>
                  )}
                </div>
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        width: `${Math.min(prizeProgress, 100)}%`,
                        height: "100%",
                        background:
                  ...
                  >
                    {Math.round(prizeProgress)}% complete •{" "}
                    {prizePool.required_participants -
                      prizePool.current_participants}{" "}
                    more needed
                  </p>
          ...
          >
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, rgba(2, 8, 23, 0.98), rgba(10, 10, 26, 0.98))",
                backdropFilter: "blur(20px)",
                textAlign: "center",
            ...
            >
              ...
              >
                You must be{" "}
                <strong style={{ color: "#ef4444" }}>18 years or older</strong>{" "}
                to participate in paid quiz competitions with rewards.
              </p>
              <div
                style={{
                  padding: "20px",
              ...
              >
                ...
                >
                  By confirming, you certify that you are 18+ and agree to
                  participate in this knowledge-based quiz competition.
                </p>
              </div>
              <div
                style={{
              ...
              >
                Free quiz option is available for all ages without age
                verification.
              </p>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <li>
                    Cash prizes are paid within 7 days after KYC verification
                  </li>
                  <li>Free rounds credited immediately to account</li>
                  <li>
                    If minimum not met, rewards roll over to next month
                  </li>
                  <li>Rounds start automatically every 15 minutes</li>
                  <li>
                    Only players who are in the lobby at the time can join the
                    round
                  </li>
                </ul>
              </div>
