...
const items = [
  { date: "8/20/2025", title: "Launch: VibraXX Studio", desc: "Text-to-video demo is live. Generate, preview, download & share.", neon: "var(--v1)" },
  { date: "8/18/2025", title: "Pricing Update", desc: "Trial, Starter, Creator and Pro packs are now available globally.", neon: "var(--v2)" },
  { date: "8/15/2025", title: "Watermark Toggle", desc: "You can choose watermark or no-watermark packs per need.", neon: "var(--v3)" },
];
