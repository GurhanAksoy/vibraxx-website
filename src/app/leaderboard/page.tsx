      ...
      <div style={{
        ...
        <div style={{ padding: "clamp(20px,5vw,40px) clamp(16px,4vw,24px)" }}>
          ...
          <header style={{
            ...
            >
              <div style={{ position: "relative", width: 80, height: 80, borderRadius: "9999px", padding: 4, background: "radial-gradient(circle at 0 0,#7c3aed,#d946ef)", boxShadow: "0 0 20px rgba(124,58,237,0.6)", flexShrink: 0 }}>
                <div className="animate-glow" style={{ position: "absolute", inset: -5, borderRadius: "9999px", background: "radial-gradient(circle,#a855f7,transparent)", opacity: 0.4, filter: "blur(8px)", pointerEvents: "none" }} />
