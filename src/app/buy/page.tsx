      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 640px) {
          /* Header tek satırda kalır — asla alt alta düşmez */
          .lb-header        { gap: 6px; }
          .lb-tab-btn       { padding: 7px 6px; font-size: 9px; letter-spacing: 0; min-height: 34px; }
          .lb-logo-circle   { width: 36px !important; height: 36px !important; }
          .lb-logo-title    { display: none !important; }
          .lb-live-badge    { padding: 4px 7px; font-size: 10px; }
        ...
        @media (max-width: 380px) {
          .lb-tab-btn     { padding: 6px 4px; font-size: 8px; }
          .lb-logo-circle { width: 30px !important; height: 30px !important; }
          ...
          <header className="lb-header">
            ...
            <div className="lb-logo-wrap" onClick={() => router.push("/")}>
              ...
              >
                <div style={{
                  ...
                  <Image src="/images/logo.png" alt="VibraXX Logo" fill sizes="44px" style={{ objectFit: "contain", padding: "14%" }} />
                </div>
              </div>
              <span
            ...
            <div className="lb-right">
              <div className="lb-live-badge">
                <div className="animate-pulse" style={{ width: 6, height: 6, borderRadius: "50%", background: "#22c55e", flexShrink: 0 }} />
                <span style={{ fontSize: "clamp(9px,2vw,11px)", color: "#22c55e", fontWeight: 700 }}>Live</span>
              </div>
              <button
                onClick={toggleMusic}
                ...
                style={{
                  ...
                  background: isMusicPlaying ? "linear-gradient(135deg,rgba(139,92,246,.9),rgba(124,58,237,.9))" : "rgba(15,23,42,.8)",
                  cursor: "pointer", transition: "all .3s",
                  boxShadow: isMusicPlaying ? "0 0 12px rgba(139,92,246,.5)" : "none",
                }}
              >
                {isMusicPlaying
                  ? <Volume2 className="animate-pulse" style={{ width: 15, height: 15, color: "white" }} />
                  : <VolumeX style={{ width: 15, height: 15, color: "#94a3b8" }} />
                }
              </button>
            </div>
          </header>
